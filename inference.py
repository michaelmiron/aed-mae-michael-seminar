...
def inference(model: torch.nn.Module, data_loader: Iterable,
    ...
    np.savez("checkpoints/avenue/predictions.npz",
             predictions_teacher=predictions_teacher,
             predictions_student_teacher=predictions_student_teacher,
...
def evaluate_model(predictions, labels, videos,
    ...
    with open("checkpoints/avenue/results.json", "w") as f:
        json.dump({
